 ...
 */
public class single_test3Activity extends Activity implements RadioGroup.OnCheckedChangeListener, View.OnClickListener, CompoundButton.OnCheckedChangeListener {
        ...
        switch (v.getId()) {
            case R.id.btn_next:
                ...
                if (rb != null) {
                    ...
                    btn_next.setText("当前得分:" + score + " 请点击进行主观题练习");
                    Intent intent = new Intent(single_test3Activity.this, subject_test.class);
